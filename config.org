...
(add-hook 'c-mode-common-hook
          (lambda ()
            (when (derived-mode-p 'c-mode 'c-ts-mode 'c-or-c++-ts-mode 'c++-mode 'java-mode)
              (ggtags-mode 1))))
#+end_src

#+RESULTS:
| lambda | nil | (when (derived-mode-p 'c-mode 'c-ts-mode 'c-or-c++-ts-mode 'c++-mode 'java-mode) (ggtags-mode 1))       |
| lambda | nil | (if (derived-mode-p 'c-mode 'c-ts-mode 'c-or-c++-ts-mode 'c++-mode 'java-mode) (progn (ggtags-mode 1))) |
